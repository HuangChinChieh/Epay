...
var BackendAPI = function (BID, APIUrl) {
    ...
    this.getProviderPrePaidHistory = function (startDate, endDate, providerCode, operatorType, cb) {
        var url = APIUrl + "/GetProviderPrePaidHistory";
        var postData = {
            BID: BID,
            StartDate: startDate,
            EndDate: endDate,
    ...
    this.updatePrePaidPoint = function (providerCode, amount, currencyType, cb) {
        var url = APIUrl + "/UpdatePrePaidPoint";
        var postData;
    ...
    //#region CompanyBlockChainAddress
    this.getBlockChainAddressResult = function (companyID, cb) {
        var url = APIUrl + "/GetBlockChainAddressResult";
        var postData;
    ...
    this.insertBlockChainAddress = function (blockChainAddress, cb) {
        var url = APIUrl + "/InsertBlockChainAddress";
        var postData;
    ...
    this.updateBlockChainAddress = function (blockChainAddress, blockChainAddressID, cb) {
        var url = APIUrl + "/UpdateBlockChainAddress";
        var postData;
    ...
    this.deleteBlockChainAddress = function (blockChainAddressID, cb) {
        var url = APIUrl + "/DeleteBlockChainAddress";
        var postData;
    ...
    this.getConfigSettingFormServer = function (cb) {
        var url = APIUrl + "/GetConfigSettingFormServer";
        var postData;
    ...
    this.WithdrawalCreateBC = function (data, userKey, cb) {
        var url = APIUrl + "/WithdrawalCreateBlockChain";
        var postData;
    ...
    this.updateWebsiteOption = function (withdrawOption, cb) {
        var url = APIUrl + "/UpdateWebsiteOption";
        var postData;
    ...
    this.getBlockChainRate = function (currencyType, cb) {
        var url = APIUrl + "/GetBlockChainRate";
    ...
    this.getAllBlockChainRate = function (cb) {
        var url = APIUrl + "/GetAllBlockChainRate";
    ...
    this.updateBlockChainRate = function (currencyType, rate, upFloatRate, downFloatRate, cb) {
        var url = APIUrl + "/UpdateBlockChainRate";
        var postData;

        postData = {
            BID: BID,
            Currency: currencyType,
            UpFloatRate: upFloatRate,
            DownFloatRate: downFloatRate,
            Rate: rate
        };
    ...
    this.createBlockChainRate = function (currencyType, rate, upFloatRate, downFloatRate, cb) {
        var url = APIUrl + "/CreateBlockChainRate";
        var postData;
    ...
    this.getCompanyWhiteListProviderBankCard = function (BankCardGUID, cb) {
        var url = APIUrl + "/GetCompanyWhiteListProviderBankCard";
        var postData;
    ...
    this.insertCompanyWhiteListProviderBankCard = function (forCompanyID, UserIdentity, Description, BankCardGUID, cb) {
        var url = APIUrl + "/InsertCompanyWhiteListProviderBankCard";
        var postData;
    ...
    this.deleteCompanyWhiteListProviderBankCard = function (WhiteListID, cb) {
        var url = APIUrl + "/DeleteCompanyWhiteListProviderBankCard";
        var postData;
    ...
    this.changePaymentProcessStatusAndRealAmount = function (PaymentSerial, RealAmount, cb) {
        var url = APIUrl + "/ChangePaymentProcessStatusAndRealAmount";
        var postData;
    ...
    this.getAllProviderPointBC = function (companyid, ServiceType, currencyType, cb) {
        var url = APIUrl + "/GetAllProviderPointBC";
    ...
    this.insertProviderCodeResult = function (providerCode, providerName, introducer, providerUrl, merchantKey, merchantCode, notifySyncUrl, notifyAsyncUrl, providerAPIType, collectType, withdrawRate, companyID, isPrePaid, BankCardTimeoutSecond, WalletTimeoutSecond, cb) {
        ...
        postData = {
            ...
            forCompanyID: companyID,
            isPrePaid: isPrePaid,
            BankCardTimeoutSecond: BankCardTimeoutSecond,
            WalletTimeoutSecond: WalletTimeoutSecond
        };
    ...
    this.InsertProviderBankCard = function (ProviderCode, CurrencyType, BankCardState, Type, CardType, BankCardName, BankCode, BankName, BranchName
        ...
        , AmountMax
        , TotalCreditValueDay
        , TotalCreditValueWeek
        , TotalCreditValueMonth
        , AmountMin
        , ServiceStartDate
        , ServiceEndDate
        , cb) {

        var url = APIUrl + "/InsertProviderBankCard";
        var postData;
    ...
    this.UpdateProviderBankCard = function (ProviderCode, BankCardGUID, BankCardState, CurrencyType, CardType, BankCardName, BankCode, BankName, BranchName
        ...
        var url = APIUrl + "/UpdateProviderBankCard";
        var postData;
    ...
    this.deleteProviderBankCard = function (BankCardGUID
        , cb) {

        var url = APIUrl + "/DeleteProviderBankCard";
        var postData;
    ...
    this.updateProviderCodeResult = function (providerCode, providerName, introducer, providerUrl, merchantKey, merchantCode, notifySyncUrl, notifyAsyncUrl, providerAPIType, collectType, withdrawRate, companyID, isPrePaid, BankCardTimeoutSecond, WalletTimeoutSecond, cb) {
    ...
    this.getSummaryBlockChainByDateResult = function (postdata, cb) {

        var url = APIUrl + "/GetSummaryBlockChainByDateResult";
        postdata["BID"] = BID;
        callServiceByPost(url, postdata, function (success, text) {
            if (success == true) {
                var obj = getJSON(text);
    ...
    this.insertProviderWithdrawLimitResult = function (providerCode, currencyType, minLimit, maxLimit, charge, Rate, WithdrawLimitType, cb) {
    ...
    this.updateProviderWithdrawLimitResult = function (providerCode, currencyType, minLimit, maxLimit, charge, Rate, WithdrawLimitType, cb) {
    ...
    this.insertProviderWithdrawLimitBlockChainRateResult = function (providerCode, currencyType, minLimit, maxLimit, blockChainRate, ServiceType, cb) {
        ...
        var postdata = {
            ...
            MinLimit: minLimit,
            MaxLimit: maxLimit,
            BlockChainRate: blockChainRate,
            ServiceType: ServiceType
        }

        var url = APIUrl + "/InsertProviderWithdrawLimitBlockChainRateResult";
    ...
    this.updateProviderWithdrawLimitBlockChainRateResult = function (providerCode, currencyType, minLimit, maxLimit, blockChainRate, ServiceType, cb) {
        ...
        var url = APIUrl + "/UpdateProviderWithdrawLimitBlockChainRateResult";
    ...
    this.insertCompanyWithdrawLimitResult = function (companyid, currencyType, minLimit, maxLimit, charge, ServiceType, Rate, WithdrawLimitType, cb) {
    ...
    this.updateCompanyWithdrawLimitResult = function (companyid, currencyType, minLimit, maxLimit, charge, ServiceType, Rate, WithdrawLimitType, cb) {
    ...
    this.getProviderWithdrawLimitResult = function (providerCode, cb) {
        ...
        var url = APIUrl + "/GetProviderWithdrawLimitResult";
    ...
    this.getProviderBankCardResult = function (providerCode, cb) {
        ...
        var url = APIUrl + "/GetProviderBankCardResult";
    ...
    //#region 支付寶
    this.GetQrCodeContent = function (imageData, cb) {
        var url = APIUrl + "/GetQrCodeContent";
        var postData;
    ...
    this.UpdateAlipayImage = function (imageData, imageName, IP, companyID, type, imageID, cb) {
        var url = APIUrl + "/UpdateAlipayImage";
        var postData;
    ...
    this.InsertProviderAlipay = function (ProviderCode, CurrencyType, BankCardState, Type, CardType, BankCardName
        , Description
        , AmountMax
        , TotalCreditValueDay
        , TotalCreditValueWeek
        ...
        , AmountMin,
        ServiceStartDate,
        ServiceEndDate, AlipayArray
        , cb) {

        var url = APIUrl + "/InsertProviderAlipay";
        var postData;
    ...
    this.UpdateProviderAlipay = function (ProviderCode, BankCardGUID, BankCardState, CurrencyType, CardType, BankCardName, Description
        , AmountMax
        , TotalCreditValueDay
        , TotalCreditValueWeek
        , TotalCreditValueMonth
        ...
        var url = APIUrl + "/UpdateProviderAlipay";
        var postData;
    ...
    this.deleteProviderAlipay = function (BankCardGUID
        , cb) {

        var url = APIUrl + "/DeleteProviderAlipay";
        var postData;
